...
6. Keeper's confirm/escalate/correct outcome is the override signal for this quantum, per [ADR: Production Monitoring & Drift Detection](../ADRs/ADR-ai-vendor-risk-and-monitoring.md).
