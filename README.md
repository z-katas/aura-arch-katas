...
| **Animal welfare cost: ~93% reduction** ($16,310 → $1,114/wk) | Derived — see [cost analysis](other_design_docs/cost-analysis.md). AI monitoring + keeper review on ~15% flagged. |
...
Refer to [detailed outcomes & cost analysis](design docs/cost-analysis.md).
